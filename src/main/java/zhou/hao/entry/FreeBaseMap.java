...
//	private Integer[] intArr = null;
	...
	public FreeBaseMap(int degreeNum, int nodeNum) {
		...
		ZipReaderService zipReader = new ZipReaderService(freeBaseZipPath, "rEdge");
		...
		zipReader = new ZipReaderService(freeBaseZipPath, "pEdge");
		...
		System.out.println("  > 完成" + nodeNum + "个节点的GFreeBaseMap初始化工作！！！" + TimeStr.getTime() + "\n");
	}
...
//		FreeBaseMap map = new FreeBaseMap(LocalFileInfo.getNodeIdAndKeywordAndEdgeZipPath(), 20);
		System.out.println(TimeStr.getTime());
