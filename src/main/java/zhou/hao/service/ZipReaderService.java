...
public class ZipReaderService {
	...
	public ZipReaderService() {}
	
	public ZipReaderService(String filePath) {
		this.filePath = filePath;
		init();
	}
	
	public ZipReaderService(String filePath, String entityName) {
		this.filePath = filePath;
...
//		ZipReaderService zrs = new ZipReaderService(LocalFileInfo.getNodeIdAndKeywordAndEdgeZipPath(), "keyword");
		ZipReaderService zrs = new ZipReaderService(LocalFileInfo.getBasePath() + "orginal_code\\data\\temp\\nodeIdAndKeywordAndEdge.zip", "keyword");
...
//		}
	...
	public void getEdgeBlankZip() throws Exception{
		ZipReaderService zrs = new ZipReaderService(LocalFileInfo.getNodeIdAndKeywordAndEdgeZipPath(), "edge");
		String lineStr = zrs.readLine();
		System.out.println(lineStr);
		int keyNum = Integer.parseInt(lineStr.split("#")[0]);
		System.out.println("总node数：" + keyNum);
