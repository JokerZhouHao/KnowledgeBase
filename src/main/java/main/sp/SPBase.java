...
//		System.out.println("<" + Global.curRecIndex + ">");
...
//			}
		...
		KSPBase kSPExecutor = new KSPBase(rgi, cReach, searchedDatesWids, wid2DateNidPair, minMaxDateSer, wordPNMap, maxDateSpans, signInRange);
	...
	public static void test(String[] args) throws Exception{
		...
		if(Global.isTest) {
			...
			System.out.println("> SPBASE 开始测试样本 nwlen=" + String.valueOf(Global.MAX_PN_LENGTH) + " " + 
								"mds=" + String.valueOf(Global.maxDateSpan) + " " + 
								"t=" + String.valueOf(searchType) + " " +
								"ns=" + String.valueOf(numSample) + " " +
								"r=" + String.valueOf(radius) + " " +
		...
		if(Global.isTest) {
			bw.close();
			System.out.println("> Over SPBASE 测试样本 nwlen=" + String.valueOf(Global.MAX_PN_LENGTH) + " " +   
					"mds=" + String.valueOf(Global.maxDateSpan) + " " + 
					"t=" + String.valueOf(searchType) + " " +
					"ns=" + String.valueOf(numSample) + " " +
					"r=" + String.valueOf(radius) + " " +
